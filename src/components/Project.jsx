...
const Project = () => {
  return (
    ProjectData.map((item,index)=>(
         ...
         <div className='relative'><img src={item.img} className='rounded-xl sm:h-[30vh]' alt="" />
         <div className='bg-primary w-full sm:h-[30vh] absolute top-0 opacity-50 group-hover:opacity-0 duration-500 ease-initial sm:block hidden ' 
       style={{
