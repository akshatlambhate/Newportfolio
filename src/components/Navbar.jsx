   ...
   {/*  */}
    ...
    <div className='flex gap-5 items-center'>
        <ul className='flex gap-3 items-end h-12 mb-1'>
          <Link to='hero' smooth={true} duration={600}><li className='text-white font-medium cursor-pointer  hover:text-primary ' id='menu'> <span className='text-primary'>#</span> Home</li></Link>
        ...
        <RouterLink to='https://drive.google.com/file/d/14BSe-eSdQDsZh7iuLJ1g0Lsu9IW_nc2s/view?usp=sharing' target='_blank'>
